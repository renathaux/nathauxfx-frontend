...
test('mobile Live Trading routes directly to authenticated app mobile-panel mode', () => {
  assert.match(mobile, /href="\/app\?desktop=1&from=mobile&open=menuPaperBtn"[^>]*><span>↗<\/span><strong>Live Trading<\/strong>/);
