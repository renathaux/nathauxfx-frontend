(function(){
  ...
  const locked = [
    { key:'logo', selector:'.landing-logo', x:-9, y:30, width:202, height:46, scaleText:true, logo:true, baseWidth:202, baseHeight:46, baseFont:28.5 },
    ...
    { key:'heroImage', selector:'.hero-right', x:114, y:-712, width:292, height:168, imageBox:true }
  ];
