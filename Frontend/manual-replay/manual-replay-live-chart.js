(() => {
  ...
  function ensureDrawingSvg() {
    ...
    svg.setAttribute('width', String(state.container?.clientWidth || 800));
    svg.setAttribute('height', String(state.container?.clientHeight || 460));
    svg.setAttribute('viewBox', '0 0 ' + (state.container?.clientWidth || 800) + ' ' + (state.container?.clientHeight || 460));
    return svg;
  }
